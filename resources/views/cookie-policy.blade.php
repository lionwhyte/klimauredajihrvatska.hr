...
@section('content')
    <div class="container mt-4 mx-auto mb-96 px-4">
        <h1 class="text-2xl text-indigo-700 font-semibold mb-6">Politika kolačića</h1>
        ...
        <h2 class="text-lg font-semibold text-sky-700 mt-6 mb-2">Što su kolačići?</h2>
        ...
        <h2 class="text-lg font-semibold text-sky-700 mt-6 mb-2">Vrste kolačića koje se koriste:</h2>
        <ol>
        ...
        <h2 class="text-lg font-semibold text-sky-700 mt-6 mb-2">Upravljanje kolačićima:</h2>
