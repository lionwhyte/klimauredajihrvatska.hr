...
class ContactFormUserResponse extends Mailable
{
    ...
    {
        return new Content(
            view: 'emails.contact_form_user_response',
        );
    }
